...
<div className='body999'>
  ...
  <h1 style={{backgroundColor:'#09AFDF',borderRadius:'9px',marginLeft:'-9.5vw',marginTop:'-3vh',position:'fixed',width:'90%',color:'white'}}>Quizella <span onClick={this.props.onHide} style={{cursor:'pointer',textAlign:'right',float:'right' }}>  &ensp;x&ensp;</span></h1>
