         ...
         <ul>
          ...
          <div class="description">
            ...
            {this.props.prizemoney ? (
              <h5 style={{ textAlign: "left", fontWeight: "700",padding:"10px 10px 10px 0px" }}>
            ...
            <div style={{display:"flex",flexDirection:"row",justifyContent:"space-between"}}>
              <p onClick={this.showGeneralQuizDetails}><button id="foot"><button class="button-os">GENERAL QUIZ</button></button></p>
              <p onClick={this.showAgroQuizDetails}>
              <button id="foot"><button class="button-os">AGRO QUIZ</button></button>
              </p>
            </div>) : (
            <div style={{display:"flex",flexDirection:"row",justifyContent:"space-between"}}>
              <p style={{fontWeight:"700",padding:"10px 10px 10px 0px"}}>{this.props.deadline ? (<span >Submission deadline:<br/>{this.props.deadline}</span>) : null}</p>
              <p class="read-more">
                {this.props.ps ? (
