...
function ResultTreasureHunt() {
  return (
    <div className="ResultCard">
      <div className="ResultCard__Cell ResultCard__Event--TreasureHunt">
        <img
          src="https://raw.githubusercontent.com/hariomvc/prakriti-images/main/Events/TreasureHunt.png"
          alt="Winner's Image"
          class="ResultCard__Image"
        />
        <div className="ResultCard__Detials">
          <h2 className="ResultCard__EventName"> Treasure Hunt </h2>
          <h4 className="ResultCard__Winner">
            ...
            <div className="ResultCard__Winner--section">
              ...
              <span className="ResultCard__Winner--sub ResultCard__Winner--block">
                College of Agriculture Bhubaneswar OUAT
              </span>
            </div>
          </h4>
        </div>
...
export default ResultTreasureHunt;